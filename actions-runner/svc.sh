...
SVC_NAME="actions.runner.notenoughnowjy-test_ci_cd.JunYoungui-MacBookAir"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (notenoughnowjy-test_ci_cd.JunYoungui-MacBookAir)"
